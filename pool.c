...
"        integers which specify the payouts by rank. The first 3\n"
...
"        https://seifertd.github.io/tournament3/2026/config.txt\n"
...
"        ignored\n"
"    7.  Optionally, include exactly 4 ‘Region: Name’ lines (e.g.\n"
"        ‘Region: East’) to name the four regions. They can appear\n"
"        anywhere in the file. If omitted, regions are labeled Region 1\n"
"        through Region 4 in the teams report.\n"
"    8.  Sample teams.txt file:\n"
"        https://seifertd.github.io/tournament3/2026/teams.txt\n"
"4.  Collect entries\n"
...
"            ruby web/make_bracket.rb ./2026/teams.txt ./web/2026_bracket.html ./2026/ncaa_2026.logo\n"
...
"                urldata format.\n"
"        2.  NOTE: The teams file MUST contain exactly 4 'Region: Name'\n"
"            lines for the bracket generator to label the regions\n"
"            correctly. See the sample teams.txt file above for correct\n"
"            format.\n"
"    3.  Latest NCAA Tournament Bracket:\n"
"        https://seifertd.github.io/tournament3/web/2026_bracket.html\n"
...
"        https://seifertd.github.io/tournament3/2025/results.txt\n"
...
"scorer uses as input the bracket being scored, the winning team number,\n"
"the losing team number, the round number and the game number. In\n"
"addition to the scorer, the pool configuration specifies\n"
"6 round scores that the scorer can use. The default round scores are\n"
...
"2.  Upset: each correct pick is worth the round score for the\n"
"    game’s round plus the seed number of the winning team.\n"
"3.  SeedDiff: each correct pick is worth the round score for the\n"
...
"4.  RelaxedSeedDiff: each correct pick is worth the round score for\n"
...
"5.  JoshP: each correct pick is worth the round score for the\n"
"    game's round multiplied by the seed number of the winning team.\n"
"6.  UpsetMultiplier: each correct pick is worth the round score\n"
